...
Langfristiges Ziel: Bekannt sein für wirklich starke Personal Brands und gleichzeitig selbst eine starke, authentische Brand haben — rund um Authentizität, Beziehungsbasiertes Marketing, eigene Geschichte, Werte und KI.

---

## HAUPTANGEBOT: EMBODYBRAND

Preis: 13.000€ brutto (Netto Wendy ca. 7.500€)
Dauer: 12 Wochen | Max. 2 neue Klientinnen pro Monat
...
Woche 3: "Der Aufbruch" — ab ca. 16 Jahren
Woche 4: "Jetzt bin ich erwachsen?!" — ab ca. 18 Jahren
Woche 5: "Business-Woman" — Business-Identität, Warum, Wille, Weg
Woche 6: "JETZT & HIER" — Gegenwart
Woche 7: "Mein Zukunfts-ICH" — Vision
Woche 8: "Ästhetik Baby" — Brand-Ästhetik
Woche 9: "Deine BRANDSTORY" — Zusammenführung, emotionaler Höhepunkt

Interviews (Außenperspektiven):
- Nach Woche 2: Familie/enge Bezugspersonen aus Kindheit/Jugend
- Nach Woche 4: Langjährige Freundin/Wegbegleiterin
- Woche 5: Kundin/Kunde (Business-Perspektive)
- Woche 6: Partner/Partnerin (privates Innenleben)

Wöchentliche Struktur:
1. Wochenvideo + Impulsfrage von Wendy
2. Sprachnachricht der Klientin (mind. 6 Min, kein Filter)
3. Fragen & Aufgaben zur Woche (ganze Woche beschäftigen)
4. Aufgabe 1 — emotional vertiefend (z.B. Woche 1: alte Kuscheltiere)
5. Aufgabe 2 — immer gleich: mind. 1 Post zur Erkenntnis/Erinnerung der Woche
6. Abschlusscall: immer selber Wochentag, aufgezeichnet
...
Ziel: 10 Retainer-Klientinnen = ca. 1.600€ netto/Monat
Positionierung: Brand Intelligence Partnerschaft, kein Support
...
PREMIUM. IMMER. Wendy verkauft 13.000€.
...
Live: https://web-production-afd9f.up.railway.app
...
- Kosten pro Klientin: ca. 26€/Monat (API + Railway)
